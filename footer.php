                    ...
                    <div class="col-lg-4">
                        ...
                        <div id="useful-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                            <ul class="nav flex-column pb-lg-1 mb-lg-3">
                                ...
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Our Works</a></li>
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">About</a></li>
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Blog</a></li>
                            </ul>
                            <ul class="nav flex-column mb-2 mb-lg-0">
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Terms &amp; Conditions</a></li>
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Privacy Policy</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-3">
                        ...
                        <div id="social-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                            <ul class="nav flex-column mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">LinkedIn</a></li>
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Twitter</a></li>
                                <li class="nav-item"><a href="https://silicon.createx.studio/landing-digital-agency.html#" class="nav-link d-inline-block px-0 pt-1 pb-2">Behance</a></li>
                            </ul>
                        </div>
                    </div>
